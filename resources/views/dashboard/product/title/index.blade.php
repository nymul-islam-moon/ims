            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route('product.title.store') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="form-row">
                        ...
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('product.title.edit', $productTitle->id) }}">Edit</a>
                                                <form action="{{ route('product.title.destroy', $productTitle->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <td>{{ $productTitle->code }}</td>
                                    <td>{{ $productTitle->name }}</td>
                                    <td>{{ $productTitle->rel_to_subcategory->rel_to_category->name }}</td>
                                    <td>{{ $productTitle->rel_to_subcategory->name }}</td>
